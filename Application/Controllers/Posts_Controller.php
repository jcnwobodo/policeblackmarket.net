...
class Posts_Controller extends A_Controller
{
    ...
    public static function handleCommentPost(RequestContext $requestContext, $post_id)
    {
        ...
        $author_name = $requestContext->getField('author_name', INPUT_POST);
        $author_email = $requestContext->getField('author_email', INPUT_POST);
        $author_comment = $requestContext->getField('author_comment', INPUT_POST);
