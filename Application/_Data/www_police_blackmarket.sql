...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2015 at 11:16 PM
...
INSERT INTO `site_categories` (`id`, `guid`, `parent`, `caption`, `type`, `status`) VALUES
(1, 'news', NULL, 'News', 'post', 1),
(2, 'extortion', NULL, 'Extortion', 'report', 1),
(3, 'bribery', NULL, 'Bribery', 'report', 1);
...
(22, NULL, 4, 6, 1449273661, 'report', 'it''s quite bad, lots of bad eggs in the NPF', 1);
...
(3, 2, 'UNN', NULL, 'district', '0.000', '0.000', 1),
(4, NULL, 'Ebonyi', 'Salt of the Nation', 'state', '24.500', '34.100', 1),
(7, NULL, 'Anambra', 'Home For All', 'state', '40.100', '45.123', 1),
(8, 1, 'Enugu North', '', 'lga', '40.100', '50.157', 1),
(9, 8, 'Ogui Road', '', 'district', '24.500', '45.123', 1);
...
(7, '565875b0bdbe06.70203316', 1, 'admin', 1448578800, 'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:40.0) Gecko/20100101 Firefox/40.0', '::1', 1449273661, 1);
...
--
ALTER TABLE `site_locations`
  MODIFY `id` bigint(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
